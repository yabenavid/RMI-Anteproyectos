...
public class jfrmAdministrador extends javax.swing.JFrame {
     ...
     */
    GestionUsuariosInt objGestionUsuariosInt;
    public jfrmAdministrador() {
        initComponents();
        this.setLocationRelativeTo(null);
         this.setResizable(false);
    }
    public jfrmAdministrador(GestionUsuariosInt objGestionUsuariosInt) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(pnlPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 572, Short.MAX_VALUE))
        );
    ...
    private void btnRegistrarUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarUsuariosMouseClicked
        ...
        RegistrarUsuarios registrar = new RegistrarUsuarios(objGestionUsuariosInt);
    ...
    private void btnConsultarUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConsultarUsuariosMouseClicked
       pnlPrincipal.removeAll();
        pnlPrincipal.repaint();
        ListarUsuarios formato = new ListarUsuarios(objGestionUsuariosInt);
